  ...
  async function cadastrarFuncionario() {
    ...
    try {
      if (editandoId != null) {
        ...
        onSuccess?.('Voluntário editado com sucesso.');
      } else {
      ...
      onError?.(err instanceof ApiError ? err.message : 'Erro ao salvar voluntário.');
    } finally {
      setSalvando(false);
    }
  }
  ...
  return (
    <div className="card border-0 shadow-sm mb-4">
      <div className="card-body">
        <h4 className="mb-4">
          {editandoId != null ? 'Editar Voluntário' : 'Cadastrar Voluntário'}
        </h4>
